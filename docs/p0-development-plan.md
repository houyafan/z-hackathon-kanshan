...
| 行为 | 奖励 |
| --- | --- |
| `article/read` | 经验 +5，学识值 +5 |
| `pin/read` | 经验 +3，学识值 +3 |
| `video/watch` | 经验 +8，学识值 +5 |
| `novel/read` | 经验 +10，学识值 +6 |
| `*/like` | 经验 +1，心情 +3 |
| `*/collect` | 经验 +2，心情 +5 |
| `*/comment` | 经验 +3，心情 +8 |
...
- 未领养时展示领养按钮；已领养时展示刘看山等级、阶段、累计经验、学识值、心情。
- 领养成功后初始化 3D 刘看山，并提示“你好，我是刘看山~”。

P0 公共展示建议：

- 刘看山悬浮模型可在推荐页和个人页复用。
- 简单状态面板展示等级、阶段、累计经验、学识值、心情。
...
P1 触发旅行资格时，建议读取 P0 的等级、阶段、学识值、心情值，作为门槛和主题权重输入。
